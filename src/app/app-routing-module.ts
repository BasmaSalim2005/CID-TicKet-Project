...
const routes: Routes = [
  { path: 'tutorial', loadComponent: () => import('./tuto/tutorial').then(m => m.TutorialComponent) },
  ...
  { path: 'tickets/assigned-count', component:AssignedCount, canActivate: [RoleAuthGuard], data: { roles: ['ADMIN'] } },
  { path: 'tickets/ticdetails/user/:id', component: TicketDetails, canActivate: [RoleAuthGuard], data: { roles: [ 'USER', 'DEVELOPER', 'TECHNICIAN','ADMIN' ] } },
  ...
  { path: 'tickets/ticdetails/admin/:id', component: TicketDetailsAdmin, canActivate: [RoleAuthGuard], data: { roles: ['ADMIN', 'USER', 'DEVELOPER', 'TECHNICIAN'] } },
  ...
  { path: 'feedback/allfeedback', component: Allfeedback, canActivate: [RoleAuthGuard], data: { roles: ['ADMIN'] } },
   { path: 'feedback/summary/:id', component: Summary, canActivate: [RoleAuthGuard], data: { roles: ['ADMIN'] } },
