...
export class ApplicationService {
  ...
  getAllTickets(): Observable<any> {
    return this.http.get<any>(`${envirement.ticketService}/getall`);
  }
  ...
  closeTicket(id: number): Observable<any> {
    return this.http.put<any>(`${envirement.ticketService}/close/${id}`, null);
  }
  approveTicket(id: number): Observable<any> {
    return this.http.put<any>(`${envirement.ticketService}/approve/${id}`, null);
  }
  cancelTicket(id: number): Observable<any> {
    return this.http.put<any>(`${envirement.ticketService}/cancel/${id}`, null);
  }
  solveTicket(id: number, sol: string): Observable<any> {
    // const params = new HttpParams().set('sol', sol as string);
    // console.log(params)
    return this.http.put<any>(`${envirement.ticketService}/solve/${id}/${sol}`, null);
  }
  ...
  getStatusDetails(id: number): Observable<any> {
    return this.http.get<any>(`${envirement.ticketService}/status/detail/${id}`);
  }
  inProgressStatus(id: number): Observable<any> {
    return this.http.put<any>(`${envirement.ticketService}/inprogress/${id}`, null);
  }
  getAssignedCountByDev(): Observable<any> {
    return this.http.get<any>(`${envirement.ticketService}/assigned/count/all`);
  }
  ...
  getFeedbackByApp(appId: number): Observable<any> {
    return this.http.get<any>(`${envirement.feedbackService}/byapp/${appId}`);
  }
}
