...
export class ApplicationService {
  ...
  notapproveTicket(id: number): Observable<any> {
    return this.http.get<any>(`${envirement.ticketService}/notapprove/${id}`);
  }
  ...
  getFeedbackByApp(appName: string): Observable<any> {
    const params = new HttpParams().set('appName', appName);
    return this.http.get<any>(`${envirement.feedbackService}/byapp`, { params });
  }
}
